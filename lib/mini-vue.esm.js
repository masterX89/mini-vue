...
function genChildren(nodes, context) {
    if (nodes.length === 1) {
        ...
        if (type === 4 /* NodeTypes.TEXT */ || type === 1 /* NodeTypes.INTERPOLATION */ || type === 5 /* NodeTypes.COMPOUND_EXPRESSION */) {
...
function getShapeFlag(type) {
    return isString(type) ? 1 /* ShapeFlags.ELEMENT */ : 4 /* ShapeFlags.STATEFUL_COMPONENT */;
}
...
export { createApp, createVNode as createElementVNode, createRenderer, createTextVNode, getCurrentInstance, h, inject, nextTick, provide, ref, registerRuntimeCompiler, renderSlot, toDisplayString };
